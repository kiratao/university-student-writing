...
### University Student Writing Skill
...
**大学生多文体写作**是一个面向大学生日常生活、学业、实践活动写作的Skill。几乎包含你能想到的所有实用的文体，它会先判断文体与接收对象，再选择相应规范和 LaTeX 模板；信息不足时保留醒目的待填写字段，不替用户虚构经历、数据、引语、奖项或审批事实。
