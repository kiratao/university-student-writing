...
DEFAULT_OUTPUT = ROOT / "dist" / "university-student-writing-1.0.0.zip"
...
FORBIDDEN_TEXT = ("[TODO:", "example.com", "C:\\Users\\", "/Users/")
TEXT_SUFFIXES = {".json", ".md", ".py", ".tex", ".sty", ".yaml", ".yml", ".txt"}
...
def build_archive(output: Path, force: bool) -> int:
